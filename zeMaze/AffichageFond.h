...
{
	int x;
	int y;                                //Déclaration des structures
};
...
//Extrants: Aucun
void Afficher(Ligne Grille[],int fond, int mur, int sou, int mario, int koopa, int goomba, int bomb, Position Mario, Position Koopa, Position Goomba, Position Bomb);
